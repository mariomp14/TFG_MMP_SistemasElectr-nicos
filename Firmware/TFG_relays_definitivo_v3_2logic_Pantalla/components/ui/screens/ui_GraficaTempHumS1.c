...
{
    ui_GraficaTempHumS1 = lv_obj_create(NULL);
    lv_obj_remove_flag(ui_GraficaTempHumS1, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    lv_obj_set_style_bg_color(ui_GraficaTempHumS1, lv_color_hex(0x7FD8E2), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_GraficaTempHumS1, 255, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_BackButtomRa5 = lv_button_create(ui_GraficaTempHumS1);
    lv_obj_set_width(ui_BackButtomRa5, 195);
    lv_obj_set_height(ui_BackButtomRa5, 53);
    lv_obj_set_x(ui_BackButtomRa5, 0);
    lv_obj_set_y(ui_BackButtomRa5, -129);
    lv_obj_set_align(ui_BackButtomRa5, LV_ALIGN_CENTER);
    lv_obj_add_flag(ui_BackButtomRa5, LV_OBJ_FLAG_SCROLL_ON_FOCUS);     /// Flags
    lv_obj_remove_flag(ui_BackButtomRa5, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    lv_obj_set_style_radius(ui_BackButtomRa5, 30, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui_BackButtomRa5, lv_color_hex(0x003F5C), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_BackButtomRa5, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    //lv_obj_set_style_shadow_color(ui_BackButtomRa5, lv_color_hex(0x000000), LV_PART_MAIN | LV_STATE_DEFAULT);
    //lv_obj_set_style_shadow_opa(ui_BackButtomRa5, 255, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_BackText5 = lv_label_create(ui_BackButtomRa5);
    lv_obj_set_width(ui_BackText5, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_BackText5, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_align(ui_BackText5, LV_ALIGN_CENTER);
    lv_label_set_text(ui_BackText5, "BACK");
    lv_obj_set_style_text_color(ui_BackText5, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui_BackText5, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui_BackText5, &lv_font_montserrat_20, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_Chart1 = lv_chart_create(ui_GraficaTempHumS1);
    lv_obj_set_width(ui_Chart1, 413);
    lv_obj_set_height(ui_Chart1, 229);
    ...
    lv_chart_set_point_count(ui_Chart1, 48);
    lv_chart_set_range(ui_Chart1, LV_CHART_AXIS_PRIMARY_Y, -10, 60);
    ...
    lv_scale_set_range(ui_Chart1_Xaxis, 0, 24 > 0 ? 24 - 1 : 0);
    lv_scale_set_total_tick_count(ui_Chart1_Xaxis, (24 > 0 ? 24 - 1 : 0) * 2 + 1);
    ...
    lv_scale_set_range(ui_Chart1_Yaxis1,  -10, 60);
    lv_scale_set_total_tick_count(ui_Chart1_Yaxis1, (15 > 0 ? 15 - 1 : 0) * 2 + 1);
    ...
    lv_scale_set_total_tick_count(ui_Chart1_Yaxis2, (10 > 0 ? 10 - 1 : 0) * 2 + 1);
    lv_scale_set_major_tick_every(ui_Chart1_Yaxis2, 2 >= 1 ? 2 : 1);
    lv_chart_series_t * ui_Chart1_series_1 = lv_chart_add_series(ui_Chart1, lv_color_hex(0x00D93A),
                                                                 LV_CHART_AXIS_PRIMARY_Y);
    static lv_coord_t ui_Chart1_series_1_array[] = { 0 };
    lv_chart_set_ext_y_array(ui_Chart1, ui_Chart1_series_1, ui_Chart1_series_1_array);
    lv_chart_series_t * ui_Chart1_series_2 = lv_chart_add_series(ui_Chart1, lv_color_hex(0xFF00A3),
                                                                 LV_CHART_AXIS_SECONDARY_Y);
    static lv_coord_t ui_Chart1_series_2_array[] = { 60 };
    ...
    ui_Panel12 = lv_obj_create(ui_GraficaTempHumS1);
    lv_obj_set_width(ui_Panel12, 118);
    lv_obj_set_height(ui_Panel12, 50);
    lv_obj_set_x(ui_Panel12, -177);
    lv_obj_set_y(ui_Panel12, -125);
    ...
    ui_temptext = lv_label_create(ui_Panel12);
    ...
    lv_label_set_text(ui_temptext, "TEMPERATURA");
    lv_obj_set_style_text_color(ui_temptext, lv_color_hex(0x00D93A), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui_temptext, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui_temptext, &lv_font_montserrat_14, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_Panel15 = lv_obj_create(ui_GraficaTempHumS1);
    lv_obj_set_width(ui_Panel15, 118);
    lv_obj_set_height(ui_Panel15, 50);
    lv_obj_set_x(ui_Panel15, 174);
    lv_obj_set_y(ui_Panel15, -125);
    lv_obj_set_align(ui_Panel15, LV_ALIGN_CENTER);
    lv_obj_remove_flag(ui_Panel15, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    lv_obj_set_style_radius(ui_Panel15, 30, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    ui_humText = lv_label_create(ui_Panel15);
    lv_obj_set_width(ui_humText, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_height(ui_humText, LV_SIZE_CONTENT);    /// 1
    lv_obj_set_align(ui_humText, LV_ALIGN_CENTER);
    lv_label_set_text(ui_humText, "HUMEDAD");
    lv_obj_set_style_text_color(ui_humText, lv_color_hex(0xFF00A3), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui_humText, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui_humText, &lv_font_montserrat_16, LV_PART_MAIN | LV_STATE_DEFAULT);

    lv_obj_add_event_cb(ui_BackButtomRa5, ui_event_BackButtomRa5, LV_EVENT_ALL, NULL);
